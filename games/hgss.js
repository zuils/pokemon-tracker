var hgss = {
    ...
    warps: {
        ...
        azalea: {
			...
			well:      {x: 702, y: 159                            },
			gym:       {x: 253, y: 325                            },
			charcoal:  {x: 480, y: 299                            },
			gate:      {x: 50,  y: 200                            },
			unioncave: {x: 878, y: 365, name: "Route 33 (Azalea)" },
        },
        goldenrod: {
			gate:       {x: 504, y: 22  },
		...
		r2_viridian: {
			...
			r2_cave:			{x: 440, y: 39 , name: "Route 2"			},
			r2_gate_leftcave:	{x: 130, y: 90 , name: "Route 2"			},
			r2_house:			{x: 597, y: 357, name: "Route 2"			},
			r2_gate_underhouse:	{x: 700, y: 773, name: "Route 2"			},
			gate_south:			{x: 448, y: 773, name: "Route 2"			},
		},
		r5: {
			gate: 	{x: 334, y: 452 },
			tunnel:	{x: 422, y: 371  },
		...
		r10_power: {
			center:		{x: 295, y: 72 , name: "Route 10" 		},
			cave_10:	{x: 180, y: 93 , name: "Route 10" 		},
			cave_lav:	{x: 86 , y: 666, name: "Route 10" 		},
		...
		ilex_r34: {
			ilex_south:	{x: 148, y: 860, name: "Ilex Forest" },
			ilex_north:	{x: 116, y: 56 , name: "Ilex Forest" },
			r34_ilex:	{x: 237, y: 111, name: "Route 34" 	 },
		},
		r35_athlon_r36: {
		...
		goldenrodgts: {
			...
			red:		{x: 556, y: 94 , name: "Goldenrod GTS 1F" },
		},
		goldenrodtunnel: {
			tunnel_stairs_n:	{x: 70 , y: 80 , name: "Goldenrod Tunnel" },
			tunnel_stairs_s:	{x: 70 , y: 400, name: "Goldenrod Tunnel" },
		...
		darkcave1: {
			r31: 		{x: 119, y: 409 },
			darkcave2:	{x: 455, y: 68  },
			r46: 		{x: 920, y: 813 },
		},
		darkcave2: {
			r45: 		{x: 967, y: 39	  },
			darkcave1:	{x: 134, y: 726	  },
		},
		unioncave: {
		...
		mtmortar2: {
			entry_left:		{x: 240, y: 915, name: "Mt. Mortar B1F" },
			entry_right:	{x: 590, y: 915, name: "Mt. Mortar B1F" },
			ladder_sw:		{x: 112, y: 715, name: "Mt. Mortar B1F" },
			ladder_se:		{x: 800, y: 715, name: "Mt. Mortar B1F" },
			ladder_up:		{x: 128, y: 84,  name: "Mt. Mortar B1F" },
			ladder_down:	{x: 238, y: 400, name: "Mt. Mortar B1F" },
		},
		icepath1: {
		...
		icepath2: {
			...
			b2f_up_w:	{x: 590, y: 277, name: "Ice Path B3F" },
			b2f_up_e:	{x: 880, y: 290, name: "Ice Path B3F" },
		},
		dragonsden: {
			ladder:		{x: 465, y: 126, },
		...
		victoryroad2: {
			...
			f3_down_e:	{x: 847, y: 197, name: "Victory Road 3F" },
		...
		seafoam2: {
			...
			b3f_down_n:		{x: 553, y: 81 , name: "Seafoam Island B3F"},
		...
		ceruleancave: {
			f1_entry:   		{x: 744, y: 891 },
			f1_right_up:		{x: 841, y: 553 },
			f1_right_down:		{x: 841, y: 696 },
			f1_mid_right:		{x: 682, y: 731 },
			f1_mid_left:		{x: 506, y: 776 },
			f1_left_upnorth:	{x: 182, y: 635 },
			f1_left_upsouth:	{x: 73 , y: 752 },
			f2_right:			{x: 855, y: 111 },
			f2_left:			{x: 74 , y: 166 },
		},
		mtsilverin: {
			...
			f1_rightout:	{x: 666, y: 750, name: "Mt. Silver 1F"},
		...
		mtsilverout: {
			...
			snow_south:		{x: 400, y: 470, name: "Mt. Silver Snow"},
