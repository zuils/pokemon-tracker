var hgss = {
    ...
    warps: {
		...
		mtmortar2: {
			entry_left:		{x: 240, y: 899, name: "Mt. Mortar (Lower Cave)" },
			entry_mid:		{x: 590, y: 899, name: "Mt. Mortar (Lower Cave)" },
			entry_right:	{x: 957, y: 853, name: "Mt. Mortar (Lower Cave)" },
			ladder_sw:		{x: 112, y: 699, name: "Mt. Mortar (Lower Cave)" },
			ladder_se:		{x: 800, y: 699, name: "Mt. Mortar (Lower Cave)" },
    ...
    marks: [
		...
		[["bike_needed", 0], ["p_trainer",   0], ["c_darkness", 0], ["team_rocket", 0]],
        [["p_bush",      0], ["p_surf",      0], ["p_boulder",  0], ["c_whirlpool", 0], ["p_rock",   0], ["p_waterfall", 0], ["p_rockywall", 0]],
    ],
    progress: [
