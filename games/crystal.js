var crystal = {
    ...
    warps: {
        ...
        tintower_burnedtower: {
			burned_fall:     {x: 387, y: 20,  name: "Burned Tower"          },
			burned_entrance: {x: 401, y: 128, name: "Burned Tower"          },
			burned_stairs:   {x: 319, y: 171, name: "Burned Tower"          },
			tinL_left:       {x: 335, y: 198, name: "Tin Tower (L)"         },
        ...
        lighthouse: {
			...
			f5_hole:      {x: 594, y: 450, name: "Lighthouse (F5 outer)" },
			f5_fall:      {x: 594, y: 368, name: "Lighthouse (F5 outer)" },
			f5_stairstop: {x: 384, y: 342, name: "Lighthouse (F5 outer)" },
			f5_stairsmid: {x: 484, y: 404, name: "Lighthouse (F5 inner)" },
        ...
        mtmoon_r3_r4: {
			...
			moon_stairstop: {x: 319, y: 60,  name: "Mt. Moon" },
			moon_doortop:   {x: 158, y: 70,  name: "Mt. Moon" },
			moon_stairsbot: {x: 347, y: 140, name: "Mt. Moon" },
			moon_doorbot:   {x: 349, y: 260, name: "Mt. Moon" },
        },
        mtsilver_r28: {
