let gen3crossover = {
    ...
    locations: {
        ...
        */			
        ...
        department_store: {x: 285,  y: 35,  w: 8,  h: 8,  name: "Department Store"                                            },
        ...
        */
        ...
        departmentstore:         {x: 159, y: 147, w: 8, h: 8, name: "Department Store"            },
    ...
    warps: {
        ...
        */
        ...
        goldenrod: {
            ...
            mart:        {x: 473, y: 673 },
            bike:        {x: 550, y: 711 },
            radf3right:  {x: 280, y: 18  },
            radf3cent:   {x: 158, y: 18  },
            radf3left:   {x: 40,  y: 18  },
            pcenterance: {x: 477, y: 186 },
            pcstairs   : {x: 373, y: 141 },
            pcback     : {x: 400, y: 18  },
        },
        ecruteak: {
            burned:    {x: 120, y: 164                           },
        ...
        lighthouse: {
            f1_entrance:  {x: 278, y: 1214,                          name: "Lighthouse (F1)"  },
            f1_stairs:    {x: 128, y: 1058,                          name: "Lighthouse (F1)"  },
            f1_drop:      {x: 412, y: 1134,                          name: "Lighthouse (F1)"  },
            ...
            f2_drop:      {x: 900, y: 1064,                          name: "Lighthouse (F2)"  },
            f3_entrance:  {x: 67,  y: 442,                           name: "Lighthouse (F3)"  },
            f3_hole:      {x: 418, y: 717,                           name: "Lighthouse (F3)"  },
            f3_stairs:    {x: 387, y: 460,                           name: "Lighthouse (F3)"  },
            f3_drop:      {x: 417, y: 587,                           name: "Lighthouse (F3)"  },
            f3_midstairs: {x: 227, y: 581, corridor: "f3_midstairs", name: "Lighthouse (F3)"  },
            f3_middrop:   {x: 227, y: 449, corridor: "f3_middrop",   name: "Lighthouse (F3)"  },
        ...
        icepath1: {
            ...
            b2f_stairsup:     {x: 340, y: 598 ,                             name: "Ice Path (B2F)"        },
            b2f_stairsdown:   {x: 180, y: 725 ,                             name: "Ice Path (B2F)"        },
            b2f_dropbotleft:  {x: 79 , y: 803 ,                             name: "Ice Path (B2F)"        },
            b2f_dropbotright: {x: 240, y: 803 ,                             name: "Ice Path (B2F)"        },
            b2f_droptopleft:  {x: 79 , y: 619 ,                             name: "Ice Path (B2F)"        },
            b2f_droptopright: {x: 238, y: 593 ,                             name: "Ice Path (B2F)"        },
        },
