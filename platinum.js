var platinum = {
    ...
    warps: {
        ...
        galactichq: {
            bf2_left:   {x: 79,  y: 163, name: "Galactic HQ (Basement)"  },
			bf2_bot:    {x: 228, y: 199, name: "Galactic HQ (Basement)"  },
			bf2_top:    {x: 176, y: 79,  name: "Galactic HQ (Basement)"  },
			...
			f12_stairs: {x: 461, y: 49,  name: "Galactic HQ (\∪)"        },
			f2_stairs:  {x: 76,  y: 489, name: "Galactic HQ (Room)"      },
			f2_tv:      {x: 368, y: 458, name: "Galactic HQ (Room)"      },
			f2_bot:     {x: 623, y: 565, name: "Galactic HQ (Room)"      },
			f2_top:     {x: 622, y: 424, name: "Galactic HQ (Room)"      },
			f22_tele:   {x: 128, y: 386, name: "Galactic HQ (Small)"     },
			f22_left:   {x: 207, y: 330, name: "Galactic HQ (Small)"     },
			f22_right:  {x: 322, y: 393, name: "Galactic HQ (Small)"     },
			f3_left:    {x: 629, y: 756, name: "Galactic HQ (Teleports)" },
			f3_mid:     {x: 655, y: 655, name: "Galactic HQ (Teleports)" },
			f3_right:   {x: 733, y: 717, name: "Galactic HQ (Teleports)" },
			f3_stairs:  {x: 920, y: 569, name: "Galactic HQ (Teleports)" },
			f4_right:   {x: 942, y: 326, name: "Galactic HQ (Office)"    },
			f4_left:    {x: 770, y: 325, name: "Galactic HQ (Office)"    },
			f4_green:   {x: 960, y: 500, name: "Galactic HQ (Office)"    },
        ...
        ironisland: {
			exterior_entrance: {x: 243, y: 51,  name: "Iron Island (Exterior)"       },
			exterior_house:    {x: 146, y: 167, name: "Iron Island (Exterior)"       },
			exterior_ledge:    {x: 53, y: 95,   name: "Iron Island (Exterior Ledge)" },
			f1_entrance:       {x: 419, y: 143, name: "Iron Island (Small)"          },
			f1_left:           {x: 335, y: 41,  name: "Iron Island (Small)"          },
			f1_right:          {x: 500, y: 39,  name: "Iron Island (Small)"          },
			bf2_top:           {x: 686, y: 54,  name: "Iron Island (Summer)"         },
			bf2_left:          {x: 712, y: 385, name: "Iron Island (Summer)"         },
			bf2_right:         {x: 923, y: 389, name: "Iron Island (Summer)"         },
			bf3_left:          {x: 333, y: 196, name: "Iron Island (Trainerless)"    },
        ...
        victoryroad: {
			...
			f1_left1:    {x: 80,  y: 324, name: "Victory Road (Main)"  },
			f1_left2:    {x: 87,  y: 475, name: "Victory Road (Main)"  },
			f1_left3:    {x: 132, y: 598, name: "Victory Road (Main)"  },
			f1_right1:   {x: 638, y: 349, name: "Victory Road (Main)"  },
			f1_right2:   {x: 712, y: 442, name: "Victory Road (Main)"  },
			f1_right3:   {x: 658, y: 564, name: "Victory Road (Main)"  },
			f1_exit:     {x: 572, y: 72,  name: "Victory Road (Main)"  },
			bf1_bot:     {x: 953, y: 363, name: "Victory Road (Water)" },
			bf1_mid:     {x: 910, y: 283, name: "Victory Road (Water)" },
			bf1_top:     {x: 898, y: 75,  name: "Victory Road (Water)" },
        },
