var platinum = {
    ...
    locations: {
        ...
        // Important locations
        departmentstore: {x: 0,  y: 0,  w: 25,  h: 25, scale: 1, name: "Department Store" },
    },
    ...
    warps: {
        ...
        // Important locations
        departmentstore: {
            one:   {x: 40, y: 10, name: "Test"},
            two:   {x: 40, y: 40, name: "Test"},
            three: {x: 40, y: 80, name: "Test"},
        },
    },
    ...
    progress: [
        ...
        [["e4_bug",     0], ["e4_ground",    0], ["e4_fire",      0], ["e4_psychic",  0], ["",    undefined], ["",     undefined], ["",     undefined], ["p_champ",      0]],
